...
helm upgrade --install --wait \
    ...
    --set env.RELIEF_WEB_APP_NAME=${RELIEF_WEB_APP_NAME} \
    --set env.POWERBI_AZURE_CLIENT_ID=${POWERBI_AZURE_CLIENT_ID} \
    --set env.POWERBI_REPORT_ID=${POWERBI_REPORT_ID} \
    --set env.POWERBI_WORKSPACE_ID=${POWERBI_WORKSPACE_ID} \
    ...
    --set env.OIDC_RSA_PRIVATE_KEY_BASE64_ENCODED=${OIDC_RSA_PRIVATE_KEY_BASE64_ENCODED} \
    --set env.OIDC_RSA_PUBLIC_KEY_BASE64_ENCODED=${OIDC_RSA_PUBLIC_KEY_BASE64_ENCODED}
